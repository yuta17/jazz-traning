...
assert.deepEqual(cTask.segments[1].degreeLabels, ["3", "5", "♭7", "♭9", "1", "♭7", "13", "5"]);
assert.deepEqual(cTask.segments[1].notes, ["B", "D", "F", "A♭", "G", "F", "E", "D"]);
...
assert.deepEqual(dbTask.segments[1].notes, ["C", "E♭", "G♭", "A", "A♭", "G♭", "F", "E♭"]);
