  ...
  const LICK_SEGMENTS = [
    {
      ...
      rootOffset: 2,
      rootLetterOffset: 1,
      intervals: [0, 3, 7, 10, 3, 2, 0, 3],
      noteLetterOffsets: [0, 2, 4, 6, 2, 1, 0, 2],
      degreeLabels: ["1", "♭3", "5", "♭7", "♭3", "9", "1", "♭3"],
    },
    {
      id: "v",
      degree: "V7",
      ...
      rootOffset: 7,
      rootLetterOffset: 4,
      intervals: [0, 2, 4, 7, 8, 6, 5, 4, 2, 0],
      noteLetterOffsets: [0, 1, 2, 4, 5, 4, 3, 2, 1, 0],
      degreeLabels: ["1", "9", "3", "5", "♭13", "♭5", "11", "3", "9", "1"],
    },
    {
      id: "i",
      degree: "Imaj",
