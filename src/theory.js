  ...
  const KEYS = [
    {
      ...
      label: "C",
      major: ["Dm7", "G7", "Cmaj7"],
      minor: ["D-7(♭5)", "G7(♭9)", "C-6"],
    },
    {
      id: "F",
      label: "F",
      major: ["Gm7", "C7", "Fmaj7"],
      minor: ["G-7(♭5)", "C7(♭9)", "F-6"],
    },
    {
      id: "Bb",
      label: "B♭",
      major: ["Cm7", "F7", "B♭maj7"],
      minor: ["C-7(♭5)", "F7(♭9)", "B♭-6"],
    },
    {
      id: "Eb",
      label: "E♭",
      major: ["Fm7", "B♭7", "E♭maj7"],
      minor: ["F-7(♭5)", "B♭7(♭9)", "E♭-6"],
    },
    {
      id: "Ab",
      label: "A♭",
      major: ["B♭m7", "E♭7", "A♭maj7"],
      minor: ["B♭-7(♭5)", "E♭7(♭9)", "A♭-6"],
    },
    {
      id: "Db",
      label: "D♭",
      major: ["E♭m7", "A♭7", "D♭maj7"],
      minor: ["E♭-7(♭5)", "A♭7(♭9)", "D♭-6"],
    },
    {
      id: "Gb",
      label: "G♭",
      major: ["A♭m7", "D♭7", "G♭maj7"],
      minor: ["A♭-7(♭5)", "D♭7(♭9)", "G♭-6"],
    },
    {
      id: "B",
      label: "B",
      major: ["C♯m7", "F♯7", "Bmaj7"],
      minor: ["C♯-7(♭5)", "F♯7(♭9)", "B-6"],
    },
    {
      id: "E",
      label: "E",
      major: ["F♯m7", "B7", "Emaj7"],
      minor: ["F♯-7(♭5)", "B7(♭9)", "E-6"],
    },
    {
      id: "A",
      label: "A",
      major: ["Bm7", "E7", "Amaj7"],
      minor: ["B-7(♭5)", "E7(♭9)", "A-6"],
    },
    {
      id: "D",
      label: "D",
      major: ["Em7", "A7", "Dmaj7"],
      minor: ["E-7(♭5)", "A7(♭9)", "D-6"],
    },
    {
      id: "G",
      label: "G",
      major: ["Am7", "D7", "Gmaj7"],
      minor: ["A-7(♭5)", "D7(♭9)", "G-6"],
    },
  ];
